...
/**
 * <p>Java class for res_getBpeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="res_getBpeType">
 *   &lt;complexContent>
...
@XmlType(name = "res_getBpeType", propOrder = {
    "npwp15",
    "npwp16",
    "nitku",
    "namawp",
...
public class ResGetBpeType {

    @XmlElement(name = "NPWP15", required = true, nillable = true)
    protected String npwp15;
    @XmlElement(name = "NPWP16", required = true, nillable = true)
    protected String npwp16;
    @XmlElement(name = "NITKU", required = true, nillable = true)
