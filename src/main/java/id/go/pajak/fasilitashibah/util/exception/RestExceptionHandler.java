...
import id.go.pajak.fasilitashibah.util.apierror.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        ResponseEntity<Object> objectResponseEntity = buildResponseEntity(new ApiError(BAD_REQUEST, error, ex));
...
//        log.info("{} to {}", servletWebRequest.getHttpMethod(), servletWebRequest.getRequest().getServletPath());
    ...
    protected ResponseEntity<Object> handleProbis(CustomValidationException ex) {
